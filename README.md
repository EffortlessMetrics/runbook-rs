...
<p align="center">
  <a href="https://github.com/EffortlessMetrics/runbook-rs/actions/workflows/coverage.yml"><img src="https://github.com/EffortlessMetrics/runbook-rs/actions/workflows/coverage.yml/badge.svg?branch=main" alt="CI" /></a>
...
<p align="center">
  <em>A physical control surface for the Claude Code agent loop.</em>
</p>
...
README badges are public, repo-scoped trust markers. PR evidence is diff-scoped and artifact-backed. See [Verification](docs/VERIFICATION.md) for the badge meanings, generated endpoints, and PR evidence boundaries.
