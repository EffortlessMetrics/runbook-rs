...
### Optional: simulate hook traffic

You can exercise the daemon without launching Claude Code by running the Rust hook
simulator:
...
Use `--daemon` or `DAEMON_BASE_URL` to target a non-default daemon URL.
