...
README badges are public, repo-scoped trust markers. PR evidence is diff-scoped and remains in summaries and CI artifacts. See [Verification](docs/VERIFICATION.md) for badge meanings and regeneration commands.
